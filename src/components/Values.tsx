...
import { BookmarkSlashIcon, EyeIcon, TrophyIcon } from "@heroicons/react/24/solid";
...
const Values = () => {
    return (
        <Container className="flex flex-col justify-between items-center lg:flex-row lg:items-start">
            ...
            <div className="w-full flex-1 mt-8 p-8 order-2 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-1 lg:rounded-r-none hover:bg-green-400 hover:text-white">
                <div className="mb-7 pb-7 flex items-center justify-center border-b border-gray-300">
                    <BookmarkSlashIcon className="w-10 h-10 rounded-3xl text-green-600" />
                    <div className="text-center ml-4">
                        <span className="block text-xl lg:text-2xl font-semibold">Mission</span>
                    </div>
                </div>
                <p className="mb-7 font-medium text-gray-500 text-lg">
            ...
            <div className="w-full flex-1 p-8 order-1 shadow-xl rounded-3xl bg-gray-900 text-gray-400 sm:w-96 lg:w-full lg:order-2 lg:mt-0 hover:bg-green-400 hover:text-white">
                <div className="mb-8 pb-8 flex items-center justify-center border-b border-gray-600">
                    <EyeIcon className="w-10 h-10 rounded-3xl text-green-600" />
                    <div className="text-center ml-4">
            ...
            {/* Values */}
            <div className="w-full flex-1 mt-8 p-8 order-3 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-3 lg:rounded-l-none hover:bg-green-400 hover:text-white mb-">
                <div className="mb-7 pb-7 flex items-center justify-center border-b border-gray-300">
                <TrophyIcon className="w-10 h-10 rounded-3xl text-green-600" />
                    <div className="text-cente ml-4">
                        <span className="block text-xl lg:text-2xl font-semibold">Values</span>
                    </div>
                </div>
                <p className="mb-7 font-medium text-gray-500 text-lg">
