      ...
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            Torch Initiatives is dedicated to social responsibility, advocating 
            for positive youth attitudes and aptitudes while championing community sustainability.
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              <a
                href="https://x.com/torchCBO?t=ucDcWW_L1IKMXJR5b6yCew&s=09"
                target="_blank"
                rel="noopener"
              >
              ...
              <a
                href="https://www.facebook.com/Torch2024"
                target="_blank"
                rel="noopener"
              >
