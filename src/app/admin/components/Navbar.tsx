            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start">
                        ...
                        <a href="/admin" className="text-xl font-bold flex items-center lg:ml-2.5">
                            <Image width={50} height={50} src="https://demo.themesberg.com/windster/images/logo.svg" alt="Windster Logo" />
                            <span className="self-center whitespace-nowrap text-black">Admin</span>
                        </a>
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="hidden lg:flex items-center">
                            <span className="text-base font-normal text-gray-500 mr-5">Torch Initiatives</span>
                            <div className="-mb-1">
